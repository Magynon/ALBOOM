...
class _LoginScreenState extends State<LoginScreen> {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      signUp(screenWidth * 0.8, screenHeight * 0.2),
                    ],
                  ),
                ),
              ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          signIn(sectionWidth * 0.5, sectionHeight * 0.13),
          SizedBox(
  ...
  Widget signIn(double sectionWidth, double sectionHeight) {
    return Padding(
  ...
  Widget signUp(double sectionWidth, double sectionHeight) {
    return Container(
      width: sectionWidth,
      height: sectionHeight,
      // color: Colors.orange,
